...
// Importamos tus proyectos reales
          ...
          {projects.map((proj, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      <strong>Periodo:</strong> {proj.period}
                    </p>
                  </div>
                  ...
                  <Dialog.Root>
                    ...
                    <Dialog.Portal>
                      ...
                      <Dialog.Content className="fixed left-1/2 top-1/2 w-[90vw] max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border/50 bg-card/95 backdrop-blur-md p-6 shadow-2xl focus:outline-none z-50">
                ...
                {/* Lista de bullets visible en la tarjeta (solo los 2 primeros) */}
                <ul className="mt-4 list-disc pl-5 space-y-2 text-sm text-muted-foreground">
